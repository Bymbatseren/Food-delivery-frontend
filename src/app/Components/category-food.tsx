  ...
  return (
    <>
      <div className="flex gap-6 flex-wrap">
        {foodList.slice(0, 7).map((foodItem) => (
      ...
      {isModalOpen && selectedFood && (
        <div className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
          <div className="bg-white rounded-lg w-[826px] h-[412px] p-6">
            <div className="flex">
              <img
              ...
              <div className="ml-6 mt-4">
                <div className="ml-[350px] rounded-full border-[#E4E4E7] border-[1px] flex justify-center items-center">
                ...
                <div className="flex  mt-[100px]">
                  <div className="w-[100px]">
                    ...
                    <div className="text-lg">
                      ${selectedFood.price * totalNumber}
                    </div>
                  </div>
                  <div className="flex ml-[150px] justify-center items-center gap-5">
                    <div
                      onClick={minusTotalNumber}
                      className="rounded-full border-[1px] border-[#09090B] w-[44px] h-[44px] flex justify-center items-center"
                    >
                      -
                    </div>
                    <div>{totalNumber}</div>
                    <div
                      onClick={plusTotalNumber}
                      className="rounded-full border-[1px] border-[#09090B] w-[44px] h-[44px] flex justify-center items-center"
                    >
                      +
                    </div>
